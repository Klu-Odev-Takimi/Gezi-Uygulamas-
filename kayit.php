            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        ...
                        <p class="auth-page-header__text">Hesabınız yok mu? <br> Lütfen kayıt olun</p>
                        <?php 
                        if(isset($_SESSION['durum'])){
                        ?>
                        <div class="alert alert-warning" role="alert">
                          <?php echo $_SESSION['durum'];
                        ...
                        <div class="auth-form">
                            <form action="lib/islem.php" method="POST">
                                <div class="auth-form__single-field space-mb--30">
                                    ...
                                    <input type="text" name="adsoyad" id="name" placeholder="Ad soyad girin">
                                </div>
                                <div class="auth-form__single-field space-mb--30">
                                    <label for="name">Telefon</label>
                                    <input type="text" name="telefon" id="name" placeholder="Telefon numaranızı girin">
                                </div>
                                <div class="auth-form__single-field space-mb--30">
                                ...
                                <div class="auth-form__single-field space-mb--40">
                                    <p class="auth-form__info-text">Zaten bir hesabım var <a href="giris.php">Giriş yap</a></p>
                                </div>
                                <input class="auth-form__button" name="kayit-ol" type="submit" value="Kayıt Ol">
                            </form>
                        </div>
                    </div>
                </div>
